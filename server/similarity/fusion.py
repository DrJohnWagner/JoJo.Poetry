...
REGISTER_WEIGHTS = {"struct": 1.0, "sem": 0.0}    # no text field for register
...
def compute_fused_similarity(struct: StructuredScoreBreakdown, sem: SemanticScoreBreakdown) -> FusedScoreBreakdown:
    ...
    register_score = struct.register_sim * REGISTER_WEIGHTS["struct"]
    ...
    overall_score = (
        ...
        register_score * OVERALL_AXES_WEIGHTS["register"] +
