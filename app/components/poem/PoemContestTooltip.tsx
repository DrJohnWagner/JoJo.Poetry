...
export default function PoemContestTooltip({ award }: { award: Award }) {
    return (
        <span className="group relative inline-block">
            ...
            <span className="pointer-events-none invisible absolute bottom-full left-1/2 z-10 mb-2 w-max max-w-[16rem] -translate-x-1/2 rounded border border-rule bg-paper px-2.5 py-2 opacity-0 shadow-sm transition-opacity duration-150 group-hover:pointer-events-auto group-hover:visible group-hover:opacity-100">
